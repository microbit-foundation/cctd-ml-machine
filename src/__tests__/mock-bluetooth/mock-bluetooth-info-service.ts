...
class MockInfoService implements BluetoothRemoteGATTService {
	...
	modelNumberCharacteristic: BluetoothRemoteGATTCharacteristic = new MockBluetoothModelNumberCharacteristic(0, this);
...
export class MockBluetoothModelNumberCharacteristic implements BluetoothRemoteGATTCharacteristic {
	...
	readValue(): Promise<DataView> {
		...
		const selectedVersionString = this.versionNumber === 1 ? v1VersionString : v2VersionString;
