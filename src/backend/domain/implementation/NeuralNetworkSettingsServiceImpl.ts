...
export class NeuralNetworkSettingsServiceImpl implements NeuralNetworkSettingsService {
    ...
    setEpochs(epochs: number): void {
        ...
        this.setNeuralNetworkSettings(settings, new SettingsChange(new ModelOption("Epochs"), prevEpochs, epochs));
    }
    ...
    setBatchSize(batchSize: number): void {
        ...
        this.setNeuralNetworkSettings(settings, new SettingsChange(new ModelOption("Batch Size"), prevBatchSize, batchSize));
    }
    ...
    setLearningRate(learningRate: number): void {
        ...
        this.setNeuralNetworkSettings(settings, new SettingsChange(new ModelOption("Learning Rate"), prevLearnRate, learningRate));
    }
    ...
    private setNeuralNetworkSettings<T>(neuralNetworkSettings: NeuralNetworkModelSettings, settingsChange: SettingsChange<T>) {
    ...
    private setNeuralNetworkArchitecture(architecture: NeuralNetworkArchitecture): void {
        ...
        this.setNeuralNetworkSettings(newSettings, new SettingsChange(new ModelOption("Architecture"), prevArchitecture, architecture));
    }
}