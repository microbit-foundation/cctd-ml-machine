...
export class LiveDataStateAdapter implements AbstractState<LiveData<LiveDataVector>> {
    ...
    update(updater: (currentValue: LiveData<LiveDataVector>) => LiveData<LiveDataVector>): void {
    ...
    subscribe(run: (value: LiveData<LiveDataVector>) => void, invalidate?: ((value?: LiveData<LiveDataVector> | undefined) => void) | undefined): Unsubscriber {
