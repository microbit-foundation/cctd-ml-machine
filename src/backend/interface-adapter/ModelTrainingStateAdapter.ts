...
export class ModelTrainingStateAdapter implements AbstractState<ModelTraining>, ModelTraining { 
    ...
    constructor() {
        this.state = new SvelteStateAdapter(writable<ModelTraining>(
            new ModelTrainingImpl()
        ))
    }
    ...
    subscribe(run: (value: ModelTraining) => void, invalidate?: ((value?: ModelTraining | undefined) => void) | undefined): Unsubscriber {
