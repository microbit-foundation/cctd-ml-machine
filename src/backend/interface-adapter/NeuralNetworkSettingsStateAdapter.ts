...
export class NeuralNetworkSettingsStateAdapter implements AbstractState<NeuralNetworkModelSettings>, NeuralNetworkModelSettings {
    ...
    public update(updater: (currentValue: NeuralNetworkModelSettings) => NeuralNetworkModelSettings): void {
        return this.state.update(updater);
    }

    public subscribe(run: (value: NeuralNetworkModelSettings) => void, invalidate?: ((value?: NeuralNetworkModelSettings | undefined) => void) | undefined): Unsubscriber {
