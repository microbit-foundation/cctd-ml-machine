...
export class AxisController {
    ...
    constructor(
        ...
        this.selectedAxesState = new SvelteStateAdapter(writable(mlMachine.getDataService().getSelectedAxes()));
        this.availableAxesState = new SvelteStateAdapter(writable(mlMachine.getDataService().getAvailableAxes()));
