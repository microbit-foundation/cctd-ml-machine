...
<script lang="ts">
  import { t } from '../../i18n';
  import DataPageControlBar from './DataPageControlBar.svelte';
  import { onMount } from 'svelte';
  import FileUtility from '../lib/utils/FileUtility';
  import { get } from 'svelte/store';
  import { hasSomeRecordingData } from './DataPage';
  import DataPageNoData from './DataPageNoData.svelte';
  import DataPageWithData from './DataPageWithData.svelte';
