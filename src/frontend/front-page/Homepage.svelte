...
<script lang="ts">
  ...
  import FrontPageContentTile from './FrontPageContentTile.svelte';
  import DoItYourselfMachineLearningTile from './tiles/DoItYourselfMachineLearningTile.svelte';
  import NewFeaturesTile from './tiles/NewFeaturesTile.svelte';
  import WhatIsMachineLearningTile from './tiles/WhatIsMachineLearningTile.svelte';
  ...
  import MakeCodeVideoIntroductionTile from './tiles/MakeCodeVideoIntroductionTile.svelte';
