...
<script lang="ts">
  ...
  import AxesFilterVectorView from '../graphs/knngraph/AxesFilterVectorView.svelte';
  import KnnModelGraph from '../graphs/knngraph/KnnModelGraph.svelte';
  import StandardButton from '../components/buttons/StandardButton.svelte';
  import KnnModelSettings from './KNNModelSettings.svelte';
