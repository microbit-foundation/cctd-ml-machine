...
<script lang="ts">
  ...
  import ConnectedLiveGraphButtons from '../../bottom-panel/ConnectedLiveGraphButtons.svelte';
  import LiveGraphInformationSection from '../../bottom-panel/LiveGraphInformationSection.svelte';
  import { tr } from '../../../i18n';
  ...
  import LiveDataFingerprint from '../../bottom-panel/LiveDataFingerprint.svelte';
