...
class ValidationSets implements Readable<ValidationSet[]>  {
    ...
    public addRecording(gestureId: GestureID, samples: RecordingSample[], labels: string[]) {
    ...
    public subscribe(run: Subscriber<ValidationSet[]>, invalidate?: Invalidator<ValidationSet[]> | undefined): Unsubscriber {
