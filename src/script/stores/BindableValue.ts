import { Readable, Subscriber, Unsubscriber, Updater, Writable, get, writable } from "svelte/store";
...
class BindableValue<T> implements Writable<T> {
    ...
    public subscribe(run: Subscriber<T>, invalidate?: ((value?: T | undefined) => void) | undefined): Unsubscriber {
