export default {
	"da": { // APPROXIMATE SORTING ORDER: First alphabetically, then order of appearance from top to bottom of page
		...
		"content.index.videoBody": "Du kan finde en introvideo til værktøjet på DR's hjemmeside:",
	...
	"en": {
		...
		"content.index.videoBody": "You can find an intro video to the tool on DR's wepage:",
