export default {
	"da": { // APPROXIMATE SORTING ORDER: First alphabetically, then order of appearance from top to bottom of page
		...
		"content.index.setupHeading": "Virker Med micro:bit V1 og V2",
		"content.index.setupBody1": "ml-machine.org understøtter både micro:bit version 1 og 2. De to versioner er identiske med undtagelse af lyde, der vil afspilles fra computeren med v1, mens de afspilles fra micro:bit'en med v2 (der er en indbygget højtaler i v2). Tilslut din micro:bit med USB og tryk 'Tilslut' for at komme i gang.",
	...
	"en": {
		...
		"content.index.setupHeading": "Supports micro:bit V1 and V2",
		"content.index.setupBody1": "ml-machine.org supports micro:bit version 1 and 2. The two versions are identical except that sounds will play from the computer with v1 while they play from the micro:bit with v2 (there is a built-in speaker in v2). Connect your micro:bit with USB and click 'Connect' to begin.",
