...
export default {
	"da": { // APPROXIMATE SORTING ORDER: First alphabetically, then order of appearance from top to bottom of page
		...
		"content.index.newzBodyViz": "Ny visualisering af datarepreæsentationen.",
		"content.index.MLHeading": "",
		"content.index.MLSubheading": "",
		"content.index.MLExplainer1": "",
		"content.index.MLExplainer2": "",
		"content.index.MLExplainer3": "",
		"content.index.MLExplainer4": "",
		// DATA PAGE:
	...
	"en": {
		...
		"content.index.newzBodyViz": "New vizualization of the data representaion.",
		"content.index.MLHeading": "How does it work?",
		"content.index.MLSubheading": "ml-machine.org/ trains neural networks to recognize patterns in the accelerometer data.",
		"content.index.MLExplainer1": "Your curated data examples of different gestures or movements (e.g., circle, shake, jumping, running) are analyzed by a machine learning algorithm in order to find patterns in the data that can be used to predict/guess if future data samples come from the micro:bit being moved in circles, shook, taped to the leg of the person jumping, etc.",
		"content.index.MLExplainer2": "The machine learning algorithm makes a data representation of the data examples by calculating specific properties of each example, such as standard deviation, cumulated acceleration, and maximum value.",
		"content.index.MLExplainer3": "In this data representation, the data examples are shown to a neural network trainer. The algorithm shows calculated properties for each example to the neural networks that “learn” from these examples by finding patterns between the examples.",
